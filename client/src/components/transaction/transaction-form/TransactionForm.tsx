...
const TransactionForm = () => {
    const {control,errors,handleSubmit,onFormSubmit,vendorList,permitAgentList,contractList,materialCertificateList,insuranceTypeList,insuranceBrokerList,referenceDocumentheaderList,watch,addNewReferenceDocument,addNewOperationalDocument,operationalDocumentheaderList,marinePortList} = useTransactionForm();
    ...
    return(
        <form onSubmit={handleSubmit(onFormSubmit)}>
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] justify-start gap-3 mt-5">
                ...
                <EpicTextField name="planned_total_transit_days" control={control} label="Total Transit Days" placeholder="Total Transit Days" readOnly={true}  />
            </div>
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] justify-start gap-3 mt-5">
                ...
                <EpicTextField name="total_delay" control={control} label="Total Delay" placeholder="Total Delay" readOnly={true}  />
            </div>
            <div className="mt-5">
                <div className="flex justify-between items-center gap-5">
                    <div />
                    <h3>upload reference documents</h3>
                    <EpicButton label="+ add" type="button" className="w-[100px] uppercase" onClick={() => addNewReferenceDocument()} />
                </div>
            ...
            <div className="mt-5">
                <div className="flex justify-between items-center gap-5">
                    ...
                    <EpicButton label="+ add" type="button" className="w-[100px] uppercase" onClick={() => addNewOperationalDocument()} />
                </div>
